...
def get_personal_data():
    ...
    bio_text = f"""
                ...
                <p>
                    ...
                    I am excited to study Human-AI Collaboration at 
                    <a href="https://smart.mit.edu/" target="_blank">SMART (Singapore-MIT Alliance for Research and Technology)</a>
                    as a <a href="https://m3s.mit.edu/our-team/yimin-zhao" target="_blank">visiting student</a>!
                </p>
...
def get_paper_entry(entry_key, entry):
    ...
    artefacts = {'html': 'Project Page', 'pdf': 'Paper', 'video': 'Video', 'poster': 'Poster', 'code': 'Code', 'slides': 'Slides'}
    i = 0
...
def get_project_entry(entry_key, entry):
    ...
    artefacts = {'html': 'Project Page', 'pdf': 'Paper', 'video':'Video', 'code': 'Code', 'slides': 'Slides'}
    i = 0
    for (k, v) in artefacts.items():
        if k in entry.fields.keys():
            if i > 0:
